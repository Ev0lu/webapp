...
function Auth2(props) {
    ...
    const [checkEx, setCheckEx] = useState('exist')
  ...
  try {
    ...
    return (
        ...
        <div className={s.password_input}>
            ...
            {errorFields.checkEx && <span className={s.error_message}>Почта не соответствует формату</span>}


             </div>


        <Link to={mail !== '' && check !== '' && checkEx !== '' ? '/authorization_verify' : '/authorization_mail'}>
