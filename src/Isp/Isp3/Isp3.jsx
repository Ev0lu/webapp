...
function Isp3(props) {
  ...
  const [linkErrorReg, setLinkErrorReg] = useState('/zak_reg_photo');
  ...
  const selectCountry2 = async (country) => {
  ...
  const handleScroll2 = (e) => {
    ...
    if (
      ...
      if (!loading) {
        fetchLang(); // Загружаем следующую порцию стран при достижении конца прокрутки
      }
    }
  };
  const checkmarkSvg = (
