  ...
  try {
    ...
    return (
        ...
        <div className={s.password_input}>
            ...
            {/^[A-Za-z]+$/.test(login) === false && <span className={s.error_message}>Логин поддерживает только латинский алфавит</span>}
        ...
        {(pass.length<10) || (pass.length >= 25) && <span className={s.error_message}>Размер пароля должен составлять от 10 до 25 символов</span>}
        ...
        <Link to={pass === pass2 && login !== '' && tele !== '' && mail !== '' && check !== '' && (pass.length>9) && (pass.length < 25) ? '/isp_con' : '/isp2_reg'}>
